...
import br.edu.ifg.fsa.tads.licitacaoweb.config.audit.AuditEventConverter;
import br.edu.ifg.fsa.tads.licitacaoweb.domain.PersistentAuditEvent;
...
import static br.edu.ifg.fsa.tads.licitacaoweb.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
